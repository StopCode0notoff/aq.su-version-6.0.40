...
namespace ImGui
{
	...
	IMGUI_API bool          ButtonTabs(const char* label, const ImVec2& size = ImVec2(0, 0));
	IMGUI_API bool          ButtonColorChanger(ImTextureID texture, std::string label, const ImVec2& size = ImVec2(0, 0));
	IMGUI_API bool          ButtonLS(const char* label, const ImVec2& size = ImVec2(0, 0), int type = 0);
	...
	bool ListBoxVector(const char* label, int* currIndex, std::vector<std::string>& values, int heightInItems) noexcept;
