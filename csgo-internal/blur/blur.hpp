...
namespace shaders {
	...
	void create_blur(ImDrawList* drawList, ImVec2 min, ImVec2 max, ImColor col = ImColor(255, 255, 255, 255), float rounding = 11.f, ImDrawCornerFlags round_flags = 15) noexcept;
