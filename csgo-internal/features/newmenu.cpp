...
//					auto bytes = read_file_bin(STRS("astralquo\\lua\\") + active_script.m_name);
...
//		return;
//
//	for (const auto& file: get_files_with_extension(STRS("astralquo\\lua"), STRS(".lua"))) {
...
//			it->m_loaded_on_server = it->m_last_uploaded_hash == sha512::get(read_file_bin(STRS("astralquo\\lua\\") + it->m_name));
...
//				ICON("folder"),
//				[]() {
//					ShellExecuteA(0, 0, (fs::current_path() / fs::path(STRS("astralquo/lua"))).string().c_str(), 0, 0, SW_SHOWNORMAL);
//				},
...
//				ICON("book"), []() {
//					ShellExecuteA(0, 0, STRSC("https://docs.astralquo.su/"), 0, 0, SW_SHOWNORMAL);
//				},
